...
@SpringComponent
@UIScope
public class CreateModuleFormImpl extends VerticalLayout implements CreateModuleForm {
	...
	@Autowired
	public CreateModuleFormImpl(ModuleRepository moduleRepository) {

		this.moduleRepository = moduleRepository;

		CreateModulePresenter = new CreateModulePresenter(this, new ModuleServiceImpl(moduleRepository));
		this.setHandler(CreateModulePresenter);
