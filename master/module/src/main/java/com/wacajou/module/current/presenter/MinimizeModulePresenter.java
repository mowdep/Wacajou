...
public class MinimizeModulePresenter implements ConsultModuleHandler{
	private ModuleServiceImpl service;
	private MinimizeModuleComponentImpl view;
	private Query XMLFile;
	private String path;
	
	public MinimizeModulePresenter(MinimizeModuleComponentImpl moduleView,
