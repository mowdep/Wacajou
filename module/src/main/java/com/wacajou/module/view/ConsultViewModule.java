...
@UIScope
@SpringView(name = ConsultViewModule.VIEW_NAME)
public class ConsultViewModule extends VerticalLayout implements View{
	...
	public void enter(ViewChangeEvent event) {
		...
		desc.setCaption("<p>" + module.description + "</p>");
	//	image.setSource(getResource(module.img));
		parcours.setCaption("");
	}
